<x-login-layout title="ログイン">
    <div class="wrapper d-flex align-items-center">
        <form method="POST" action="{{ route("handleLogin") }}" id="login-form" class="login-form content row" style="width:100%; margin:0;" autocomplete="off">
            ...
            <div class="login_form_btm">
                <div class="form-floating mb-3 wk">
                    <input type="text" class="form-control col-md-5" id="floatingInput" name="login_id" value="{{ old('login_id') }}" data-label="Email">
    ...
    @push('style')
        <link href="{{ mix('css/screens/auth/a010.css') }}" rel="stylesheet" />
    @endpush
    @push('scripts')
        <script src="{{ mix('js/screens/auth/a010.js') }}"></script>
    @endpush
</x-login-layout>
